...
def header_record(Latitude, Longitude, ID, Name, Platform, Elevation, Bogus, Date):
    '''
    Latitude  : F20.5
    Lontitude : F20.5
...
def data_record(Pressure, Height, Temperature, DewPoint, WindSpeed, WindDirection, WindU, WindV, RelativeHumidity,
                Thickness):
    '''
    Pressure         : F13.5, Pa
    Height           : F13.5, m
