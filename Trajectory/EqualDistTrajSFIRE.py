...
from uncertainty_util import get_polygons_ctr, equal_dist_trajectory
import json
...
for select_date in select_dates:
    ...
    uncertainty_res = equal_dist_trajectory(wrf_sfire_ds, met_df, fire_obj, monitor_mappings)
    sfire_uncertainty_res[select_date] = uncertainty_res

with open("/Volumes/Shield/WindUncertaintyImpacts/TrajectoryNew/res/equal_dist_nudge.pickle", 'wb') as handle:
